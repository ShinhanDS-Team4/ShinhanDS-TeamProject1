...
//		
		// 2.나의 주문 내역
		// List<OrderProdDTO> myAllOrders =
		// orderProdService.orderProductById(member_id);
	...
	public int myAddrDelete(HttpSession session, Model model, @RequestBody Map<String, String> addrData) {
	...
	public String myInfoUpdatePwPage(HttpSession session, Model model) {
	...
	public int myInfoUpdatePw(HttpSession session, Model model, @RequestBody Map<String, String> pwData) {
...
//	}
	...
	public int myInfoUpdateForm(HttpSession session, Model model, @RequestBody Map<String, String> myInfoData) {
		String member_id = "testid";
