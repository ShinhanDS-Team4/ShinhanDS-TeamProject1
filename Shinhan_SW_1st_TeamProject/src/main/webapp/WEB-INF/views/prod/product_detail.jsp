                    ...
                    <c:forEach items="${prod_Options}" var="prodOption" varStatus="status">
                        <div>
                            ...
                            <select id="rentOptions_${status.index}" name="${prodOption.OPT_NAME}">
                                ...
                                <c:forTokens items="${prodOption.OPT_VALUE}" delims=","
                                             var="optValue">
                                    <c:set var="position"
                                           value="${fn:indexOf(optValue,'-')}"/>
                                    <c:set var="optName"
                                           value="${fn:substring(optValue,0,position) }"/>
                                    <c:set var="optLength"
                                           value="${fn:length(optValue)}"/>
                                    <c:set var="optId"
                                           value="${fn:substring(optValue,position+1, optLength) }"/>
    ...
    <div class="product_detail-inner">
        ...
        <div class="product-detail_wrap">
            ...
            <div class="product-details">
                ...
                <p class="rate">
                    ★${reviewInfo.avg_rate != null ? reviewInfo.avg_rate : 0} <span>
    ...
    $(document).ready(function() {
        ...
        $('#rentPopupForm select').on('change', function() {
            ...
            if (isChanged) {
                ...
                $('#rent_num').val(rent_num + 1); // 모든 옵션이 선택된 경우 rent_num 값을 1 증가
                // 총 가격 업데이트
